...
class UserinfosControllerTest < ActionController::TestCase
  ...
  test "should create userinfo" do
    assert_difference('Userinfo.count') do
      post :create, userinfo: { firstname: @userinfo.firstname, lastname: @userinfo.lastname, permission: @userinfo.permission, status: @userinfo.status }
    end
  ...
  test "should update userinfo" do
    patch :update, id: @userinfo, userinfo: { firstname: @userinfo.firstname, lastname: @userinfo.lastname, permission: @userinfo.permission, status: @userinfo.status }
    assert_redirected_to userinfo_path(assigns(:userinfo))
  end
